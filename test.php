...
<div class="container"> 
  <div class="row">
    ...
    <div class="col-md-5 col-sm-12 col-xs-12">
      <div class="product_title"><h3>product_title</h3></div>
      <div class="category"><span>category</span></div>
      <hr style="border: 1px rotated gray">
      <div class="price"><h4>350,000 VND</h4></div>
      ...
      <div class="description"><h4>Mô tả</h4></div>
        <p> • Chất liệu vải: Linen pha Poly nhẹ, thoáng mát.<br>
            • Form #Slim trẻ trung, hiện đại.<br>
            • Size 95-100-105</p>
    </div>
</div> 
<?php
